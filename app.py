...
def fetch_poster(movie_id):
    ...
    response = requests.get("https://api.themoviedb.org/3/movie/{}?api_key=a558d307cd75c98ab005baf015864f3e&language=en-US".format(movie_id))
    data = response.json()
